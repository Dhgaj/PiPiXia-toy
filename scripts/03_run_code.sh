...
# PiPiXia code目录测试报告生成器
# 为code目录下的每个ppx文件生成单独的Markdown报告
...
REPORT_DIR="${PROJECT_ROOT}/report/code"
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  PiPiXia Code 目录测试报告生成器${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
echo "代码目录: ${CODE_DIR}"
...
get_test_input() {
    local test_file="$1"
    case "$test_file" in
        "00_builtin_input_prompt.ppx") echo -e "Hello" ;;
        "00_builtin_input.ppx") echo -e "Test" ;;
